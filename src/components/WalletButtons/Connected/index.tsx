        ...
        <SelectContent className="">
          <SelectGroup className="">
            <div>
              ...
              <Link href="/dashboard">
                <SelectLabel className=" hover:bg-gray-100">Dashboard</SelectLabel>
              </Link>
            </div>
            ...
            <Dialog>
              <DialogTrigger asChild>
                <div className="">
                  ...
                  <SelectLabel className="cursor-pointer  hover:bg-gray-100">Wallet</SelectLabel>
                </div>
              </DialogTrigger>
                  ...
                  <div className="space-y-5">
                    ...
                    <section className="flex items-center justify-between text-[13px] w-full px-[10px]">
                      ...
                      <div className="space-x-1 cursor-pointer flex items-center" onClick={() => {
                        copyToClipboard(String(account)).then(() => {
            ...
            <SelectLabel onClick={disconnectWallet} className='cursor-pointer hover:bg-chestnut-600 hover:text-white flex items-center justify-between'>
              Disconnect
              <LogOut size={15} />
            </SelectLabel>
          </SelectGroup>
